sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("clinny/food/ManageFood/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#ManageFood-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#ManageFood-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("clinny.food.ManageFood.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["clinny/food/ManageFood/localService/mockserver"], function (mockserver) {
